...
function ServeDone() {
  ...
  return (
    <section className="p-5">
      <div className="grid grid-cols-[1fr,2fr,1fr,1fr,3fr] gap-4 border-b-2 pb-3 mb-5 text-center text-2xl bolder">
        <h3>주문 시간</h3>
        <h3>메뉴</h3>
        <h3>수량</h3>
        <h3>테이블 번호</h3>
      ...
      <div className="grid grid-cols-[1fr,2fr,1fr,1fr,3fr] gap-4 text-center text-xl">
        {tables.map((table) =>
